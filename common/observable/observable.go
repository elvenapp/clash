...
func NewObservableTyped[T any](iterable Iterable[T]) *Observable[T] {
...
func NewObservable(iterable Iterable[any]) *Observable[any] {
	return NewObservableTyped[any](iterable)
}
